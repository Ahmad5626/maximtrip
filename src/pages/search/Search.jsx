      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gray-100 py-3 px-4 rounded-md mb-6">
          <div className="flex items-center text-sm">
            ...
            <span className="text-gray-600">{initialQuery}</span>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row ">
              <div className="md:w-2/3">
                  <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                    ...
                    Explore Best Holiday Packages in {initialQuery}
                      {/* <span className="ml-2 text-sm font-normal text-[#ce3c3d]">12 Packages</span> */}
                    </h1>
              
                  </div>
                  <p className="text-gray-600 mb-2 pr-10">
                 Discover affordable and luxurious holiday packages in {initialQuery}. Explore top destinations, personalized travel plans, and unbeatable deals for your perfect getaway.
                 Looking for the best travel experiences in {initialQuery}? We’ve found top holiday packages that match your search! Whether you're planning a family vacation, a romantic getaway, or a solo adventure, these {initialQuery} packages offer unforgettable memories.

Choose from serene backwaters, lush green landscapes, houseboat stays, and cultural experiences that define God’s Own Country.
                  </p>
                ...
                <div className="md:w-1/3 ">
                  <div className="w-full">
                      <img
                        src="https://www.maximtrip.in/self/assets/img/holiday/main/6-nights-7-days-kashmir-package.png"
